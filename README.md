...
Développeur Frontend passionné basé à **Paris**, spécialisé dans l'écosystème **React/Next.js** et le **design d'interfaces utilisateur**. Avec 4 ans d'expérience, j'aime créer des expériences web performantes et élégantes.

🔍 **Actuellement à la recherche d'un CDI** pour rejoindre une équipe dynamique !
...
- 📚 Création d'une **bibliothèque de 15+ composants** réutilisables, réduisant le temps de développement de **50%**
- ⚡ Optimisation de performances web avec une réduction du temps de chargement de **15%** (Google Lighthouse)
- 📈 Amélioration du **SEO de 150%** grâce à la migration React → Next.js
- 🔒 Renforcement de la sécurité et des performances d'API de **+30%**
- 🎨 Double casquette **Dev Frontend + Designer UI/UX**
...
💡 *Ouvert aux opportunités en CDI - N'hésite pas à me contacter !*
